...
def LaGR_SEQ(flat_data):
	...
	for i in range(N_episodes):
		...
		for j in range(N_horizon):
			...
			if llmsoln_flag==0 and np.array([last_correct_sol]).size>correct_size and a2==1:
...
if __name__=="__main__":
	...
	np.savez("lagrseq"+str(temp)+".npy.npz",retloglog,corrloglog,llmcountloglog,Q)#store results